...
async function approvePreSale(){
  ...
  const sent = await AnyTokenContract.approve(PreSaleAddress, ethers.BigNumber.from("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"))
  const receipt = await sent.wait();
  console.log("Receipt: ",receipt)
  console.log("Status: ",receipt["status"])
  console.log("Hash: ",receipt["transactionHash"])
...
const MainContent = ({title, subtitle, logo}) => {
  return (
    ...
    <div class="wallet-info">
      ...
      <p>balance: <span id="balance">0</span> BNB || Chain: <span id="chain">-</span></p>
    ...
    <Button onClick={DeployPresale} variant="contained" color="primary" disableElevation >
          deploy
    </Button>
    ...
    <p></p>
    <Button onClick={claimTokens} variant="contained" color="primary" disableElevation >
          Claim Tokens
    </Button>
    <Button onClick={fin} variant="contained" color="primary" disableElevation >
          Finalize
    </Button>
